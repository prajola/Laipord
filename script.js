...
// Advanced Neural Constellation Background
...
class Particle {
    ...
    draw() {
        ...
        ctx.fillStyle = isLight ? 'rgba(255, 123, 0, 0.4)' : 'rgba(255, 255, 255, 0.2)';
        ctx.beginPath();
    ...
    for (let a = 0; a < particles.length; a++) {
        for (let b = a; b < particles.length; b++) {
            ...
            if (distance < 120) {
                ...
                ctx.strokeStyle = isLight ? `rgba(255, 123, 0, ${opacityValue * 0.15})` : `rgba(255, 255, 255, ${opacityValue * 0.1})`;
                ctx.lineWidth = 1;
                ctx.beginPath();
